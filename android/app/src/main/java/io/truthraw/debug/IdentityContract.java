...
/** Frozen research identities used by the non-canonical Android validation client.
 *
 * The client can independently verify the exact source bytes and the decoded
 * uncompressed 16-bit CFA raster. Scientific Master, Dynamic Authority and HDR
 * projection identities remain frozen research references until their exact
 * runtimes are ported and independently recomputed on-device.
 */
public final class IdentityContract {
    ...
    public static final int DECODED_CFA_WIDTH = 4080;
    public static final int DECODED_CFA_HEIGHT = 3072;
    public static final int DECODED_CFA_STRIPS = 3072;
    public static final long DECODED_CFA_BYTES = 25_067_520L;
