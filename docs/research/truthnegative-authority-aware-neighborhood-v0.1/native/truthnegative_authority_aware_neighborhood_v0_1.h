...
struct Sample{double value=0,variance=0,spatialDistance=0;SampleAuthority authority=SampleAuthority::Unknown;bool varianceKnown=false,sameChannel=true,sameObject=true,censorBoundary=false;};
