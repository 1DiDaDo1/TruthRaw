...
Validation commit `81bc0d44f256df40175e099b13a7139f6401424c`, run `34528065758`:

- sealed-module/upstream binding: PASS;
- GCC Release canonical equivalence: PASS;
- Clang Release canonical equivalence: PASS;
- Clang ASan/UBSan canonical equivalence: PASS;
- max abs SDR difference vs canonical synthetic fixture: `0`;
- max abs half-log-gain difference: `0`;
- max abs Stage-2 diagnostic difference: `0`.

This is exact equivalence for the exercised synthetic fixture and bound v4.7i implementation, not a universal proof over all DNGs or device decoders.
