...
Status bind_scientific_master_streaming(
    ...
    // Pass 1: same Scientific Master digest work as v0.1, plus the high 16
    // bits of every eligible positive finite uncensored Stage-2 float.
    ...
    // Pass 2: resolve the low 16 bits for both exact median ranks. The two
    // histograms deliberately remain separate even if both ranks share a high
    // prefix; this keeps the proof and memory upper bound simple and stable.
