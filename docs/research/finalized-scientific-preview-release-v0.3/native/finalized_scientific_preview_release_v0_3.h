...
namespace truthraw::finalized_scientific_preview_release::v0_3 {
...
struct ReleaseResult final {
    ...
    scientific_master_streaming_binding::v0_3::Result scientificIdentity{};
    technical_backplane_phase2::v0_1::Phase2Result canonicalPhase2{};
    streaming_v0_1::StreamingResult streaming{};
};

// v0.3 is scientifically identical to finalized release v0.2. The only
// intended change is use of Scientific Master Streaming Binding v0.3, whose
// bounded runtime stripes preserve the exact v0.2 Scientific Master, L0,
// Backplane and preview output while reducing source-call overhead.
Status create_and_release_finalized_scientific_preview(
    ...
    const scientific_master_streaming_binding::v0_3::Options& scientificOptions,
