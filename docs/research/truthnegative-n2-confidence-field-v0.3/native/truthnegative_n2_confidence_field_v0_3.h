...
inline constexpr const char* kSchemaName =
    "D.RAW/TruthNegative/N2ConfidenceField/0.3";
...
struct TileVector final {
    ...
    std::uint64_t centerZLe1 = 0u;
    std::uint64_t centerZ1To2 = 0u;
    std::uint64_t centerZGt2 = 0u;

    std::uint64_t v01Preserved = 0u;
    ...
    double centerZLe1Fraction = 0.0;
    double centerZ1To2Fraction = 0.0;
    double centerZGt2Fraction = 0.0;
    double preserveFraction = 0.0;
    ...
    SupportClass supportClass = SupportClass::NoCandidate;
...
struct Result final {
    ...
    Digest fieldSha256{};
    std::uint64_t noCandidateTiles = 0u;
    std::uint64_t unresolvedTiles = 0u;
    std::uint64_t mixedTiles = 0u;
    std::uint64_t fullyCoherentTiles = 0u;
    std::uint32_t tileEdge = 0u;
    std::uint32_t samplingPeriod = 0u;

    bool exactV01ParityVerified = false;
    bool exactCenterExcludedParityVerified = false;
