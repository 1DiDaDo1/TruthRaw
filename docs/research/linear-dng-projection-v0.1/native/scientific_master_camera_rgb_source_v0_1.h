...
// bounded 64x64 tile stream and writes that stream to the compatibility DNG.
// The reconstructed RGB is hashed again with the canonical Scientific Master
// digest while exporting; successful return therefore proves that the exact
// export source still has the admitted Scientific Master identity.
//
