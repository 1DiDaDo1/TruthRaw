...
jint finalized_status(const truthraw::finalized_scientific_preview_release::v0_1::Status& status) {
...
Java_com_truthraw_adaptiveui_NativeTilePreviewBridge_buildFinalizedScientificColorPreview(
    ...
    truthraw::scientific_master_streaming_binding::v0_1::Options scientificOptions;
    ...
    const auto released =
        truthraw::finalized_scientific_preview_release::v0_1::create_and_release_finalized_scientific_preview(
            prepared,
            *source,
            reconstruction,
            appearance,
