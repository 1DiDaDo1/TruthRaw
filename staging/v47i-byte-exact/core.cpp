...
Status NeutralReferenceAppearance::applyTile(const float* a,int w,int h,int cx0,int cy0,int cw,int ch,float* out) const{
...
Status SkinSafeDetailedCrispAppearance::applyTile(const float* a,int w,int h,int cx0,int cy0,int cw,int ch,float* out) const{
