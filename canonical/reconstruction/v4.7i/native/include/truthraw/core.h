...
enum class AppearanceProfile : int { NeutralReference=0, SkinSafeDetailedCrisp=1, ExternalProfile=2 };
...
public:
    ...
    Status applyTile(const float*,int,int,int,int,int,int,float*) const override;
};
