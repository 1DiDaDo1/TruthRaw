...
status_needle = '''                "STAGE 3 CAPTURE SENT · scopedRequest=true · globalMAX=$lastGlobalPixelModeWritten · physicalMAX=true · " +\n'''
status_replacement = '''                "STAGE 3 CAPTURE SENT · scopedRequest=true · globalMAX=$lastGlobalPixelModeWritten · physicalMAX=true · " +\n                    "focusMode=$lastFocusProbeMode · focusWrite=$lastFocusProbePhysicalDistanceWritten · " +\n'''
...
assert 'CaptureRequest.CONTROL_AF_MODE' in s
